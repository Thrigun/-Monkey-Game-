...
function setup() {
  ...
  invisibleGround = createSprite(315,395,600,7);
  invisibleGround.visible = false;
  
  ground=createSprite(windowWidth,400,1000,5);
...
function food(){
  if (World.frameCount%80 === 0){
    ...
    banana=createSprite(windowWidth,300,10,10);
...
function obstacles(){
  if(World.frameCount % 200 === 0){
    obstacle=createSprite(windowWidth,320,10,10);
